...
public class CallActivity extends AppCompatActivity {
    ...
    public void doStartCall() {
        ...
        if (mPeerConnection == null) {
            logcatOnUI("mPeerConnection == null  createPeerConnection");
        ...
        mPeerConnection.createOffer(new SimpleSdpObserver() {
            ...
            public void onCreateSuccess(SessionDescription sessionDescription) {
                ...
                logcatOnUI("创建一个Offer成功,并且 setLocalDescription");
                ...
                logcatOnUI("创建一个Offer成功,发送Offer给对方");
            }
        }, mediaConstraints);
    }
    ...
    public void doAnswerCall() {
        ...
        logcatOnUI("收到对方的Offer,创建一个Answer给对方");
    ...
    private PeerConnection.Observer mPeerConnectionObserver = new PeerConnection.Observer() {
        ...
        public void onSignalingChange(PeerConnection.SignalingState signalingState) {
            ...
            logcatOnUI("onSignalingChange: " + signalingState.name());
        }
        ...
        public void onIceCandidate(IceCandidate iceCandidate) {
            ...
            logcatOnUI("onIceCandidate sendMessage");
            try {
                JSONObject message = new JSONObject();
        ...
        public void onRenegotiationNeeded() {
            ...
            logcatOnUI("onRenegotiationNeeded");
        }

        @Override
        public void onAddTrack(RtpReceiver rtpReceiver, MediaStream[] mediaStreams) {
            logcatOnUI("onAddVideoTrack");
    ...
    private SignalClient.OnSignalEventListener
        ...
        private void onRemoteOfferReceived(JSONObject message) {
            if (mPeerConnection == null) {
                logcatOnUI("收到对方的Offer,createPeerConnection");
                mPeerConnection = createPeerConnection();
            }
