 ...
 */
class AutoFitPreviewBuilder2 private constructor(
    ...
    init {
        ...
        useCase.onPreviewOutputUpdateListener = Preview.OnPreviewOutputUpdateListener {
            ...
            //此时只需要把这个相机生成的 it.surfaceTexture 传递出来即可
            Log.e("Renderer","onPreviewOutputUpdateListener")
            //创建CameraEGLHelper
            val mCameraHelper : CameraEGLHelper = CameraEGLHelper()
//            mCameraHelper.bindToLifecycle()
    ...
    companion object {
        ...
        fun build(config: PreviewConfig, viewFinder: TextureView) =
            AutoFitPreviewBuilder2(config, WeakReference(viewFinder)).useCase
    }
}